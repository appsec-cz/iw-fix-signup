...
**English** · [Čeština](README.cs.md) · [Deutsch](README.de.md) · [Italiano](README.it.md) · [Türkçe](README.tr.md)
...
powershell -ExecutionPolicy Bypass -File .\iw-fix-signup.ps1 [options]
```
